...
- (void)ReorderApplicationIconBadgedNumber
{
...
- (void)applicationDidEnterBackground:(UIApplication *)application
{
    ...
    [self ReorderApplicationIconBadgedNumber];
...
{
    //when app executing or in used.
    // or app in background and not used but user selected remind icon.
    //NSLog(@"%@",notification);
